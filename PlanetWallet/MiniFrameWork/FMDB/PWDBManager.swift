...
class PWDBManager : DBManager {
    ...
    override func createTables(_ database: FMDatabase) -> Bool {
        do {
            ...
            let query4 = "INSERT INTO 'ERC20' ('keyId', 'hide', 'balance', 'name', 'symbol', 'decimals', 'img_path', 'contract') VALUES ('02c825545ec4e3de49fa28e83b3a1eadc3ecefe50d8b51f63c5db56d8340aac6a8', 'N', '', 'Binance', 'BNB', '', '/images/token/000_bnb_28_2.png', '0xB8c77482e45F1F44dE1745F52C74426C631bDD52');"
